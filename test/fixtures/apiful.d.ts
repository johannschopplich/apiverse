// Generated by `apiful generate` – do not edit.
/* eslint-disable */
declare module 'apiful/schema' {
  ...
  import { paths as PetStorePaths, components as PetStoreComponents } from 'apiful/schema/petStore'
  ...
  export type TestEcho<
    ...
    Method extends OpenAPIPathMethods<TestEchoPaths, Path>
  > = OpenAPIEndpoint<TestEchoPaths, Path, Method>
   ...
   */
  export type TestEchoApiMethods<Path extends keyof TestEchoPaths> = OpenAPIPathMethods<TestEchoPaths, Path>
  ...
  /**
   * OpenAPI endpoint type helper for the PetStore API.
   *
   * @example
   * // Get path parameters for retrieving a user by ID:
   * type UserParams = PetStore<'/users/{id}', 'get'>['path']
   *
   * // Get query parameters for listing users:
   * type UsersQuery = PetStore<'/users', 'get'>['query']
   *
   * // Get request body type for creating a user:
   * type CreateUserBody = PetStore<'/users', 'post'>['request']
   *
   * // Get success response for retrieving a user:
   * type UserResponse = PetStore<'/users/{id}', 'get'>['response']
   *
   * // Get a specific status code response:
   * type UserNotFoundResponse = PetStore<'/users/{id}', 'get'>['responses'][404]
   *
   * // Get complete endpoint type definition:
   * type UserEndpoint = PetStore<'/users/{id}', 'get'>
   */
  export type PetStore<
    Path extends keyof PetStorePaths,
    Method extends OpenAPIPathMethods<PetStorePaths, Path>
  > = OpenAPIEndpoint<PetStorePaths, Path, Method>
  
  /**
   * @example
   * type AvailablePaths = PetStoreApiPaths // Returns literal union of all available paths
   */
  export type PetStoreApiPaths = keyof PetStorePaths
  
  /**
   * @example
   * type UserMethods = PetStoreApiMethods<'/users/{id}'> // Returns 'get' | 'put' | 'delete' etc.
   */
  export type PetStoreApiMethods<Path extends keyof PetStorePaths> = OpenAPIPathMethods<PetStorePaths, Path>
  
  /**
   * @example
   * type Pet = PetStoreModel<'Pet'> // Get the Pet schema model
   * type User = PetStoreModel<'User'> // Get the User schema model
   */
  export type PetStoreModel<T extends keyof PetStoreComponents['schemas']> = PetStoreComponents['schemas'][T]
}
...
declare module 'apiful/schema/testEcho' {
  export interface paths {
    "/echo/{id}": {
      ...
      /** Echo a path parameter back */
      get: operations["echoById"];
      put?: never;
      post?: never;
      delete?: never;
      options?: never;
  ...
  export interface operations {
    echoById: {
      ...
      requestBody?: never;
      responses: {
        /** @description Successful echo of the path parameter */
        200: {
          headers: {
            [name: string]: unknown;
          };
    ...
    echoRequest: {
      ...
      responses: {
        /** @description Successful echo of the request details */
        200: {
          headers: {
            [name: string]: unknown;
          };
...
declare module 'apiful/schema/petStore' {
  export interface paths {
    "/pet": {
      parameters: {
        query?: never;
